...
This project will consist of six steps in order for me to finish the project. Working through this assignment will aid me in problem solving more efficiently - plan or pseudocode my solution, write the code, and test my code to make sure it works.
...
Skills Demonstrated
- Planning out my initial thoughts on how to tackle the assignment, by problem solving
